...
Atributes
 ...
 private HashMapInteger, node_data neighbors - hashMap containing the connected nodes. the reason it is a hash map is so we could insert and get neighbours in O(1)
...
Atributes
 private HashMapInteger, node_data nodes - contains the graph's vertices of type node_data(as well as with node_data the hashMap was used for the fast insertion and search)
